...
prefix="/Users/runner/work/sherpa-onnx/sherpa-onnx/build/lib.macosx-11.0-arm64-cpython-311/sherpa_onnx"
exec_prefix="${prefix}"
...
Libs: -L"${libdir}" -lsherpa-onnx-cxx-api -lsherpa-onnx-c-api -lonnxruntime -Wl,-rpath,${libdir}  
